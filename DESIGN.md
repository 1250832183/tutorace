...
### 6.1 核心设计原则：Less Structure（少结构化）

**核心理念**：Agent 是一个万能导师，不是"课程播放器"。永远不要拒绝或阻挡学生的学习请求。

| 原则 | 说明 |
|------|------|
| **信任学生** | 学生知道自己想学什么，不要替他们做决定 |
| **满足好奇心** | 学生问什么就答什么，好奇心是宝贵的 |
| **Slides 是辅助** | Slides 是视觉辅助工具，不是限制教学内容的边界 |
| **选择权归用户** | 用户可以随时切换课程，不需要强制学完 |

### 6.2 课程外问题处理（重要）

当学生问与当前课程无关的问题时（如在经济学课程中问量子物理）：
